...
// It's bad practice to define the function within a loop, so we'll define this here
...
for (let i=0; i<arrSongBox.length; i++) {
    // Then we call the function above individually as we iterate through all the songBoxes
    attachToggle(i);
}